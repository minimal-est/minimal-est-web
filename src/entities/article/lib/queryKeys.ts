...
export const articleKeys = {
    ...
    recommendationsInfinite: (limit: number) => [...articleKeys.all, "recommendations", "infinite", limit] as const,
    ...
    singleDetailBySlug: (penName: string, slug: string) =>
        [...articleKeys.single(), penName, slug, 'slug'] as const,
    ...
    prevAndNext: (articleId: string) =>
        [...articleKeys.all, 'prevAndNext', articleId]  as const,
    search: (query: string, page: number, size: number) =>
        [...articleKeys.all, 'search', query, page, size] as const,
};
